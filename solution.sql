...
--Give them a new account balance of 10.00.    //NOT RIGHT BELOW
UPDATE syntax_practice SET account_balance = 10.00 WHERE transactions_completed = 0.00 AND account_balance = 0.00;
...
--8. Add a new record. --HAVE NO CLUE WHY THIS IS INCORRECT BELOW:
INSERT INTO syntax_practice VALUES ('bob', 'denver', 0, 32, 450000.00);
...
--WHY DID IT LET ME USE 'AND'ABOVE AND NOT IN 5 AND 6 WHERE I WAS SELECTING THE username AND account balance.
